...
// Dashboard auto-generated for entity: subdivision-kindred-14

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const KindredRealmsDivisionSubdivision14Dashboard = () => {
  const entity = {
  "id": "subdivision-kindred-14",
  "name": "Kindred Realms Division Subdivision 14",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-kindred-sub-14-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Kindred Realms Division Subdivision 14 Dashboard</h1>
        <p>Subdivision 14 of Kindred Realms Division</p>
      </header>
...
export default KindredRealmsDivisionSubdivision14Dashboard;