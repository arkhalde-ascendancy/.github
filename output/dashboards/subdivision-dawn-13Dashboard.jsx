...
// Dashboard auto-generated for entity: subdivision-dawn-13

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision13Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-13",
  "name": "Dawn Council Division Subdivision 13",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-13-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 13 Dashboard</h1>
        <p>Subdivision 13 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision13Dashboard;