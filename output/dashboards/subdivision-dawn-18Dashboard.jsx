...
// Dashboard auto-generated for entity: subdivision-dawn-18

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision18Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-18",
  "name": "Dawn Council Division Subdivision 18",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-18-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 18 Dashboard</h1>
        <p>Subdivision 18 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision18Dashboard;