...
// Dashboard auto-generated for entity: subdivision-dawn-20

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision20Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-20",
  "name": "Dawn Council Division Subdivision 20",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-20-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 20 Dashboard</h1>
        <p>Subdivision 20 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision20Dashboard;