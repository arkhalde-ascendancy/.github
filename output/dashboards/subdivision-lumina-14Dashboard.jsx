...
// Dashboard auto-generated for entity: subdivision-lumina-14

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const LuminaOrderDivisionSubdivision14Dashboard = () => {
  const entity = {
  "id": "subdivision-lumina-14",
  "name": "Lumina Order Division Subdivision 14",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-lumina-sub-14-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Lumina Order Division Subdivision 14 Dashboard</h1>
        <p>Subdivision 14 of Lumina Order Division</p>
      </header>
...
export default LuminaOrderDivisionSubdivision14Dashboard;