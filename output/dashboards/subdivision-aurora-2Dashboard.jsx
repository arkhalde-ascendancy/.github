...
// Dashboard auto-generated for entity: subdivision-aurora-2

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const AuroraGuardiansDivisionSubdivision2Dashboard = () => {
  const entity = {
  "id": "subdivision-aurora-2",
  "name": "Aurora Guardians Division Subdivision 2",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-aurora-sub-2-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Aurora Guardians Division Subdivision 2 Dashboard</h1>
        <p>Subdivision 2 of Aurora Guardians Division</p>
      </header>
...
export default AuroraGuardiansDivisionSubdivision2Dashboard;