...
// Dashboard auto-generated for entity: subdivision-dawn-3

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision3Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-3",
  "name": "Dawn Council Division Subdivision 3",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-3-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 3 Dashboard</h1>
        <p>Subdivision 3 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision3Dashboard;