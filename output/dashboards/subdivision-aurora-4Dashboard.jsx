...
// Dashboard auto-generated for entity: subdivision-aurora-4

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const AuroraGuardiansDivisionSubdivision4Dashboard = () => {
  const entity = {
  "id": "subdivision-aurora-4",
  "name": "Aurora Guardians Division Subdivision 4",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-aurora-sub-4-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Aurora Guardians Division Subdivision 4 Dashboard</h1>
        <p>Subdivision 4 of Aurora Guardians Division</p>
      </header>
...
export default AuroraGuardiansDivisionSubdivision4Dashboard;