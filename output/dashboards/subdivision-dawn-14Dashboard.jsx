...
// Dashboard auto-generated for entity: subdivision-dawn-14

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision14Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-14",
  "name": "Dawn Council Division Subdivision 14",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-14-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 14 Dashboard</h1>
        <p>Subdivision 14 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision14Dashboard;