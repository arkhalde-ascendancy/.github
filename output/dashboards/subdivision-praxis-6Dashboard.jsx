...
// Dashboard auto-generated for entity: subdivision-praxis-6

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const PraxisArchitectsDivisionSubdivision6Dashboard = () => {
  const entity = {
  "id": "subdivision-praxis-6",
  "name": "Praxis Architects Division Subdivision 6",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-praxis-sub-6-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Praxis Architects Division Subdivision 6 Dashboard</h1>
        <p>Subdivision 6 of Praxis Architects Division</p>
      </header>
...
export default PraxisArchitectsDivisionSubdivision6Dashboard;