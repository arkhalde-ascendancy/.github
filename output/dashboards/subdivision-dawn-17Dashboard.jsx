...
// Dashboard auto-generated for entity: subdivision-dawn-17

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision17Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-17",
  "name": "Dawn Council Division Subdivision 17",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-17-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 17 Dashboard</h1>
        <p>Subdivision 17 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision17Dashboard;