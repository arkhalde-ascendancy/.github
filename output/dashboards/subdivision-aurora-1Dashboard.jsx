...
// Dashboard auto-generated for entity: subdivision-aurora-1

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const AuroraGuardiansDivisionSubdivision1Dashboard = () => {
  const entity = {
  "id": "subdivision-aurora-1",
  "name": "Aurora Guardians Division Subdivision 1",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-aurora-sub-1-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Aurora Guardians Division Subdivision 1 Dashboard</h1>
        <p>Subdivision 1 of Aurora Guardians Division</p>
      </header>
...
export default AuroraGuardiansDivisionSubdivision1Dashboard;