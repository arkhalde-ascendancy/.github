...
// Dashboard auto-generated for entity: subdivision-dawn-15

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const DawnCouncilDivisionSubdivision15Dashboard = () => {
  const entity = {
  "id": "subdivision-dawn-15",
  "name": "Dawn Council Division Subdivision 15",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-dawn-sub-15-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Dawn Council Division Subdivision 15 Dashboard</h1>
        <p>Subdivision 15 of Dawn Council Division</p>
      </header>
...
export default DawnCouncilDivisionSubdivision15Dashboard;