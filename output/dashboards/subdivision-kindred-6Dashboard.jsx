...
// Dashboard auto-generated for entity: subdivision-kindred-6

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const KindredRealmsDivisionSubdivision6Dashboard = () => {
  const entity = {
  "id": "subdivision-kindred-6",
  "name": "Kindred Realms Division Subdivision 6",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-kindred-sub-6-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Kindred Realms Division Subdivision 6 Dashboard</h1>
        <p>Subdivision 6 of Kindred Realms Division</p>
      </header>
...
export default KindredRealmsDivisionSubdivision6Dashboard;