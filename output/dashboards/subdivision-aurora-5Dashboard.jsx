...
// Dashboard auto-generated for entity: subdivision-aurora-5

import SovereignButton from '../../components/SovereignButton';
import CrestDisplay from '../../components/CrestDisplay';
import './SubdivisionDashboard.css';

const AuroraGuardiansDivisionSubdivision5Dashboard = () => {
  const entity = {
  "id": "subdivision-aurora-5",
  "name": "Aurora Guardians Division Subdivision 5",
  "type": "subdivision",
  ...
  "children": [],
  "aiGuardian": "ai-aurora-sub-5-guardian"
};
  return (
    <div className="dashboard dashboard-subdivision" data-compliance="gdpr ai-act nis2">
      <header className="dashboard-header">
        ...
        <h1>Aurora Guardians Division Subdivision 5 Dashboard</h1>
        <p>Subdivision 5 of Aurora Guardians Division</p>
      </header>
...
export default AuroraGuardiansDivisionSubdivision5Dashboard;